  ...
  return (
    <div className="surface-card p-6 sm:p-10">
      ...
      <div className="text-center">
        ...
        <span className="inline-flex rounded-xl border border-[var(--accent)] bg-[color-mix(in_oklab,var(--accent)_10%,var(--background))] px-5 py-3 font-mono text-xs uppercase tracking-widest text-[var(--primary)]">
          AI Assistant
        </span>
      </div>
